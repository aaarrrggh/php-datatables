...
<head>
	...
	<style type="text/css" title="currentStyle">
		@import "DataTables-1.8.0/media/css/demo_table.css";
	</style>
	
	<script type="text/javascript" language="javascript" src="DataTables-1.8.0/media/js/jquery.js"></script>
